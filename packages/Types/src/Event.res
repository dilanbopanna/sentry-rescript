/** JSDoc */
type exceptionType<'a> = {values?: array<Exception.exception_<'a>>}
type transactionInfo = {soruce: Transaction.transactionSource}
type thread<'a> = {values: array<Thread.thread<'a>>}
